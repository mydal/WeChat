<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"F:\xampp\htdocs\api\public/../application/admin\view\news\lists.html";i:1586329605;s:58:"F:\xampp\htdocs\api\application\admin\view\common\top.html";i:1586310097;s:59:"F:\xampp\htdocs\api\application\admin\view\common\left.html";i:1586345450;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加电影" class="btn btn-sm btn-azure btn-addon"
                        onClick="javascript:window.location.href ='<?php echo url('news/add'); ?>'"> <i class="fa fa-plus"></i> 添加
                </button>
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">电影like图标</th>
                                            <th class="text-center">电影star图标</th>
                                            <th class="text-center">电影likeNum</th>
                                            <th class="text-center">电影starNum</th>
                                        ...
                                        <tr>
                                            <td class="text-center"><input type="checkbox" value="<?php echo $value['id']; ?>"
                                                                           name="id[]" id="checkbox"
                                                                           class="cheidbox"
                                                                           style="!important; opacity: 1.2;position: static;"></td>
                                            <td class="text-center"><?php echo $value['id']; ?></td>
                                            <td class="text-center"><?php echo $value['title']; ?></td>
                                            <td class="text-center"><img src="<?php echo $value['pics']; ?>" alt="" height="40px"></td>
                                            <td class="text-center"><img src="<?php echo $value['icon1']; ?>" alt="" height="40px"></td>
                                            <td class="text-center"><img src="<?php echo $value['icon2']; ?>" alt="" height="40px"></td>
                                            <td class="text-center"><?php echo $value['likeNum']; ?></td>
                                            <td class="text-center"><?php echo $value['zanNum']; ?></td>
                                            <td class="text-center"><?php echo $value['news']['catename']; ?></td>
                                            ...
                                            <td align="center">
                                                ...
                                                <a href="#" onClick="warning('确实要删除吗', '<?php echo url('news/del',array('id'=>$value['id'])); ?>')"

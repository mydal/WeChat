<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"F:\xampp\htdocs\api\public/../application/admin\view\music\lists.html";i:1586345382;s:58:"F:\xampp\htdocs\api\application\admin\view\common\top.html";i:1586310097;s:59:"F:\xampp\htdocs\api\application\admin\view\common\left.html";i:1586345450;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加电影音乐" class="btn btn-sm btn-azure btn-addon"
                        onClick="javascript:window.location.href = '<?php echo url('add'); ?>'"><i class="fa fa-plus"></i> 添加
                </button>
                <button type="submit" tooltip="删除电影音乐" class="btn btn-danger btn-sm shi"
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">电影音乐名称</th>
                                            <th class="text-center">电影音乐专辑</th>
                                            <th class="text-center">电影音乐作者</th>
                                            <th class="text-center">电影音乐图片</th>
                                        ...
                                        <form class="piliangshanchan">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo $value['epname']; ?></td>
                                                <td class="text-center"><?php echo $value['simger']; ?></td>
                                                <td class="text-center"><img src="<?php echo $value['coverImgUrl']; ?>" height="30px" alt=""></td>
                                                ...
                                                <td align="center">
                                                    ...
                                                    <a href="#"
                                                       onClick="warning('确实要删除吗', '<?php echo url('del',array('id'=>$value['id'])); ?>')"

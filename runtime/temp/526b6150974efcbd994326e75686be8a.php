<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"F:\xampp\htdocs\api\public/../application/admin\view\news\edit.html";i:1586329934;s:58:"F:\xampp\htdocs\api\application\admin\view\common\top.html";i:1586310097;s:59:"F:\xampp\htdocs\api\application\admin\view\common\left.html";i:1586345450;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('news/lists'); ?>">电影管理</a>
                    </li>
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo url('news/edit'); ?>" method="post"  enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="username"
                                                   class="col-sm-2 control-label no-padding-right">电影likeNum</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="username" placeholder="" name="likeNum"
                                                       required="" type="text" value="<?php echo $model['likeNum']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="username"
                                                   class="col-sm-2 control-label no-padding-right">电影zanNum</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="username" placeholder="" name="zanNum"
                                                       required="" type="text" value="<?php echo $model['zanNum']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="group_id"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <img src="<?php echo $model['pics']; ?>" alt="" height="60px;">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="group_id"
                                                   class="col-sm-2 control-label no-padding-right">电影like图标</label>
                                            <div class="col-sm-6">
                                                <input type="file" name="icon1">
                                                <img src="<?php echo $model['icon1']; ?>" alt="" height="60px;">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="group_id"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <img src="<?php echo $model['icon2']; ?>" alt="" height="60px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="list_id" id="">
                                                    ...
                                                    <option value="<?php echo $value['id']; ?>" <?php if($model['list_id'] == $value['id']): ?> selected <?php endif; ?>><?php echo $value['catename']; ?></option>
                                                    <?php endforeach; ?>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" class="btn btn-default">更新电影</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"F:\xampp\htdocs\api\public/../application/admin\view\rotaion\edit.html";i:1586337747;s:58:"F:\xampp\htdocs\api\application\admin\view\common\top.html";i:1586310097;s:59:"F:\xampp\htdocs\api\application\admin\view\common\left.html";i:1586337197;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('rotaion/lists'); ?>">电影轮播图管理</a>
                    </li>
                    <li class="active">更新电影轮播图</li>
                </ul>
            </div>
            <!-- /Page Breadcrumb -->
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">更新电影轮播图</span>
                            </div>
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo url('rotaion/edit'); ?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <input type="hidden" name="id" value="<?php echo $model['id']; ?>">
                                            <label for="group_id"
                                                   class="col-sm-2 control-label no-padding-right">电影轮播图缩略图</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" class="btn btn-default">更新电影轮播图信息</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"F:\xampp\htdocs\api\public/../application/admin\view\comment\lists.html";i:1586341312;s:58:"F:\xampp\htdocs\api\application\admin\view\common\top.html";i:1586310097;s:59:"F:\xampp\htdocs\api\application\admin\view\common\left.html";i:1586345450;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加电影评论" class="btn btn-sm btn-azure btn-addon"
                        onClick="javascript:window.location.href ='<?php echo url('add'); ?>'"><i class="fa fa-plus"></i> 添加
                </button>
                <button type="submit" tooltip="删除电影评论" class="btn btn-danger btn-sm shi"
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <form class="piliangshanchan">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo $value['user']['nickName']; ?></td>
                                                <td class="text-center"><?php echo $value['article']['title']; ?></td>
    ...
    function delAll() {
        layer.confirm('确认要删除吗？', function (index) {
            if ($('.cheidbox').is(':checked')) {
                $.ajax({
                    url: "<?php echo url('comment/delAll'); ?>",

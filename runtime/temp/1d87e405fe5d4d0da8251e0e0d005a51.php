<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"F:\xampp\htdocs\api\public/../application/admin\view\login\index.html";i:1584062507;}*/ ?>
<!DOCTYPE html>
        ...
        <form action="" method="post">
            <div class="loginbox bg-white">
                ...
                <div class="loginbox-textbox">
                    ...
                    <img style="margin-top: 20px;" src="<?php echo url('login/verify'); ?>" alt="点击更新验证码"  id="verify"/>
                </div>

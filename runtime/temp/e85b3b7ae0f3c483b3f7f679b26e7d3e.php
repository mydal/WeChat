<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"F:\xampp\htdocs\api\public/../application/admin\view\mcate\edit.html";i:1586339495;s:58:"F:\xampp\htdocs\api\application\admin\view\common\top.html";i:1586310097;s:59:"F:\xampp\htdocs\api\application\admin\view\common\left.html";i:1586338707;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('Mcate/lists'); ?>">电影类别管理</a>
                    </li>
                    <li class="active">更新电影类别</li>
                </ul>
            </div>
            <!-- /Page Breadcrumb -->
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">更新电影类别</span>
                            </div>
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="<?php echo url('mcate/edit'); ?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="catename"
                                                   class="col-sm-2 control-label no-padding-right">电影类别名称</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="catename" placeholder="" name="catename"
                                                       required="" type="text" value="<?php echo $model['catename']; ?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <img src="<?php echo $model['pic']; ?>" alt="" height="30px">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" class="btn btn-default">更新电影类别信息</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>

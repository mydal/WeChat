<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"F:\xampp\htdocs\api\public/../application/admin\view\user\lists.html";i:1586342648;s:58:"F:\xampp\htdocs\api\application\admin\view\common\top.html";i:1586310097;s:59:"F:\xampp\htdocs\api\application\admin\view\common\left.html";i:1586345450;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="submit" tooltip="删除用户" class="btn btn-danger btn-sm shi"
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <form class="piliangshanchan">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?php echo $value['nickName']; ?></td>
                                                <td class="text-center"><img src="<?php echo $value['avatarUrl']; ?>" alt="" style="height: 40px;"></td>

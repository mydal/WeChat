<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"F:\xampp\htdocs\api\public/../application/admin\view\article\add.html";i:1586419365;s:58:"F:\xampp\htdocs\api\application\admin\view\common\top.html";i:1586310097;s:59:"F:\xampp\htdocs\api\application\admin\view\common\left.html";i:1586345450;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('article/lists'); ?>">电影详情管理</a>
                    </li>
                    <li class="active">添加电影详情</li>
                </ul>
            </div>
            <!-- /Page Breadcrumb -->
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">新增电影详情</span>
                            </div>
                                    ...
                                    <form class="form-horizontal" role="form" action="add" method="post"  enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" class="btn btn-default">添加电影信息</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
